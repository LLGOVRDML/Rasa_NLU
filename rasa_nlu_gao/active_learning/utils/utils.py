...
from rasa_nlu_gao.active_learning.utils.kernel_block_solver import BlockKernelSolver
from rasa_nlu_gao.active_learning.utils.small_cnn import SmallCNN
from rasa_nlu_gao.active_learning.utils.allconv import AllConv
...
def get_train_val_test_splits(X, y, max_points, seed, confusion, seed_batch,
  ...
  #  print(any(get_class_counts(y_tmp, y_tmp[0:seed_batch])))
  #  np.random.shuffle(indices)
