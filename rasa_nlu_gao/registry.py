...
from rasa_nlu_gao.classifiers.active_bert_nerual_classifier import ActiveBertNerualClassifier
...
component_classes = [
    ...
    SklearnIntentClassifier, MitieIntentClassifier, KeywordIntentClassifier,ActiveBertNerualClassifier,
